...
'''
ParseReads is a script that align reads and extract all SNPs compared to a refernce
...
#__name__="ParseReads"
from CanSNPer2.modules.DatabaseConnection import XMFAFunctions  ## Might have to be changed to ReadFunctions
import os
import logging
logger = logging.getLogger(__name__)

class ParseReads(object):
	"""docstring for ParseReads."""
	def __init__(self, verbose=False, **kwargs):
		super(ParseReads, self).__init__()
